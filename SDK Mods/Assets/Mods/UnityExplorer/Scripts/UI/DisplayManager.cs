...
namespace UnityExplorer.UI
{
    public static class DisplayManager
    {
        ...
        public static Vector3 MousePosition => Application.isEditor
            ? UInputManager.MousePosition
            : Display.RelativeMouseAt(UInputManager.MousePosition);
        ...
        public static void SetDisplay(int display)
        {
            ...
            UE_UIManager.UICanvas.targetDisplay = display;
        ...
        private static IEnumerator FixPanels()
        {
            ...
            foreach (Panels.UEPanel panel in UE_UIManager.UIPanels.Values)
            {
