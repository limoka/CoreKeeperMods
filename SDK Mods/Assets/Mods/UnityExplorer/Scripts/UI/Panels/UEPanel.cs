...
namespace UnityExplorer.UI.Panels
{
    public abstract class UEPanel : PanelBase
    {
        ...
        {
            if (UE_UIManager.Initializing || ApplyingSaveData)
                return;
        ...
        public override void ConstructUI()
        {
            ...
            if (NavButtonWanted)
            {
                ...
                NavButton = UIFactory.CreateButton(UE_UIManager.NavbarTabButtonHolder, $"Button_{PanelType}", Name);
                ...
                NavButton.OnClick += () => { UE_UIManager.TogglePanel(PanelType); };
