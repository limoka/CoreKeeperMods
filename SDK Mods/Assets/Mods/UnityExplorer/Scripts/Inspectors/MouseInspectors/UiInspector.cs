...
namespace UnityExplorer.Inspectors.MouseInspectors
{
    public class UiInspector : MouseInspectorBase
    {
        ...
        {
            yield return null;
            MouseInspectorResultsPanel panel = UE_UIManager.GetPanel<MouseInspectorResultsPanel>(UE_UIManager.Panels.UIInspectorResults);
        ...
        public override void UpdateMouseInspect(Vector2 mousePos)
        {
            ...
            {
                if (!gr || gr.getCanvasPublic() == null) continue;
