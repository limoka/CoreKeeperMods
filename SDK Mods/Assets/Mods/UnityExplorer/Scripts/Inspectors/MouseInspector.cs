...
namespace UnityExplorer.Inspectors
{
    ...
    public class MouseInspector : PanelBase
    {
        ...
        public void StartInspect(MouseInspectMode mode)
        {
            ...
            UE_UIManager.NavBarRect.gameObject.SetActive(false);
            UE_UIManager.UiBase.Panels.PanelHolder.SetActive(false);
            UE_UIManager.UiBase.SetOnTop();
        ...
        public void StopInspect()
        {
            ...
            UE_UIManager.NavBarRect.gameObject.SetActive(true);
            UE_UIManager.UiBase.Panels.PanelHolder.SetActive(true);

            Dropdown drop = InspectorPanel.Instance.MouseInspectDropdown;
            if (drop.transform.Find("Dropdown List") is Transform list)
            {
                drop.DestroyDropdownList_Public(list.gameObject);
            }
        ...
        {
            if (UInputManager.GetKeyDown(ConfigManager.World_MouseInspect_Keybind.Value))
                Instance.StartInspect(MouseInspectMode.World);

            if (UInputManager.GetKeyDown(ConfigManager.UI_MouseInspect_Keybind.Value))
        ...
        public void UpdateInspect()
        {
            ...
            if (UInputManager.GetMouseButtonDown(0))
            {
            ...
            Vector3 mousePos = UInputManager.MousePosition;
        ...
        protected override void ConstructPanelContent()
        {
            ...
            this.UIRoot.transform.SetParent(UE_UIManager.UIRoot.transform, false);
