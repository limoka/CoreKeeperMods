    ...
    public class InternalConfigHandler : ConfigHandler
    {
        ...
        public bool TryLoadConfig()
        {
            try
            {
                ...
                {
                    if (!Enum.IsDefined(typeof(UE_UIManager.Panels), key))
                        continue;

                    UE_UIManager.Panels panelKey = (UE_UIManager.Panels)Enum.Parse(typeof(UE_UIManager.Panels), key);
