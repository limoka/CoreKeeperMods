...
namespace UnityExplorer.Config
{
    public static class ConfigManager
    {
        ...
        internal static readonly Dictionary<UE_UIManager.Panels, ConfigElement<string>> PanelSaveData = new();

        internal static ConfigElement<string> GetPanelSaveData(UE_UIManager.Panels panel)
        {
        ...
        private static void CreateConfigElements()
        {
            ...
            Main_Navbar_Anchor = new("Main Navbar Anchor",
                ...
                UE_UIManager.VerticalAnchor.Top);
